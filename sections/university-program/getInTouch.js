...
export default function GetInTouchSection() {
    ...
    return (
        <div className={`relative overflow-hidden items-center w-full h-auto lg:h-screen min-h-mobile md:min-h-fit lg:min-h-lg xl:min-h-xl bg-desmos-background-secondary`}>
            <div className="container w-mobile md:w-md lg:w-lg xl:w-xl h-full px-xMobile md:px-xMd lg:px-xLg xl:px-xXl py-yMobile md:py-yMd lg:py-yLg xl:py-yXl">
                <CenteredContentLayout>
                    <div className="text-desmos-black-light grid justify-items-center flex items-center mt-[74px] md:mb-[136px] md:mt-0 lg:mb-0 lg:mt-[110px] xl:mt-0">
                        <h2 className="md:tracking-normal tracking-[.005em] font-semibold text-desmos-primary text-[24px] md:text-[32px] lg:text-[40px] leading-[36px] md:leading-[48px] lg:leading-[60px]">{t("getInTouchTitle")}</h2>
